  ...
  return (
    <Layout>
      <main className="flex min-h-screen">
        <div className="w-[70%] bg-gray-50 p-8 overflow-y-auto space-y-8">
          <div className="bg-white rounded-lg shadow p-6">
            <h1 className="text-4xl font-bold mb-6">Welcome to GDSC@WM.</h1>
            ...
            <div className="flex gap-4 mt-8">
              <Link
                to="/signup"
                className="bg-green-900 text-white px-6 py-2 rounded-full text-2xl font-medium hover:bg-green-800"
              >
                Start your application
              </Link>
              <Link
                to="/login"
                className="bg-gray-200 text-gray-700 px-6 py-2 rounded-full text-2xl font-medium hover:bg-gray-300"
              >
                Sign in
              </Link>
            </div>
        ...
        <div className="bg-gray-50 p-8 overflow-y-auto space-y-8">
          <div className="bg-white rounded-lg shadow p-6">
            ...
            <a
              ...
              className="text-xl text-blue-400 hover:text-blue-500 font-semibold"
            >
          ...
          <div className="bg-white rounded-lg shadow p-6">
            ...
            <div className="grid grid-cols-5 gap-4 text-xl mb-6">
              {[
                {
                  title: "Flat Hat Games",
                  term: "Fall '24",
                  link: "https://games.flathatnews.com/",
                  image: "/public/flathat.jpg",
                },
                {
                  title: "Recruitment",
                  term: "Fall '24",
                  link: "/",
                  image: "/public/recruitment.jpg",
                },
                {
                  title: "SAD",
                  term: "Spring '24",
                  link: "https://github.com/gdscwm/sld",
                  image: "/public/sld.jpg",
                },
                {
                  title: "Global Americas",
                  term: "Spring '24",
                  link: "https://github.com/gdscwm/Global-Americas",
                  image: "/public/global.jpg",
                },
                {
                  title: "Campus Escort",
                  term: "Spring '21",
                  link: "https://apps.apple.com/us/app/w-m-campus-escort/id1582947297",
                  image: "/public/escort.jpeg",
                },
              ].map((proj, i) => (
                <a
                  key={i}
                  href={proj.link}
                  className="relative group bg-gray-800 text-xl text-white rounded-lg p-4 flex flex-col min-h-[180px] overflow-hidden transition-transform duration-200 hover:scale-105"
                >
                  <img
                    src={proj.image}
                    alt={proj.title}
            ...
            <a
              ...
              className="text-xl text-blue-400 hover:text-blue-500 underline font-semibold"
            >
              Click here for past projects
            </a>
          </div>

          <div className="flex gap-6 mt-6 text-2xl bg-white rounded-lg shadow p-6">
            <a
