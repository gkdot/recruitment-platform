  ...
  return (
    <div className="bg-white rounded-lg shadow p-6">
      ...
      <p className="text-lg mb-4">
        ...
        workshop and we&apos;ll walk through it step by step. For any further
        questions on workshops, please reach out to{" "}
        <a
          href="mailto:developerstudentclubwm@gmail.com"
          className="text-lg text-blue-400 hover:text-blue-500 font-semibold"
        >
